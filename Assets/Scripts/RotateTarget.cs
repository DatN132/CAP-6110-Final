...
public class RotateTarget : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Determine whether the right mouse button or touch input were pressed this frame.
            ...
            // Determine whether the right mouse button or touch input were released this frame.
            ...
            else if (m_Rotating)
            {
                ...
                if ((m_RotatingFromX - Input.mousePosition.x) < 0)
                    transform.Rotate(m_ARCamera.transform.up, (m_RotatingFromX - Input.mousePosition.x) / m_ARCamera.scaledPixelWidth * 360.0f * 0.5f, Space.World);
